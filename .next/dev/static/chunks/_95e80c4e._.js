...
function AdminProducts() {
    ...
    async function loadData() {
        setIsLoading(true);
        try {
            const p = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$adminDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchCollection"])('products');
            setProducts(p);
            const c = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$adminDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchCollection"])('categories');
            setCategories(c);
        } catch (err) {
            console.error(err);
        } finally{
...
_s(AdminProducts, "YEgUomFne0nnnJYTOsPsw1fwNCQ=");
_c = AdminProducts;
var _c;
...
//# sourceMappingURL=_95e80c4e._.js.map