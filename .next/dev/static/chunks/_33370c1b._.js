...
function AdminProducts() {
    ...
    const [newProdName, setNewProdName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [newProdCategory, setNewProdCategory] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [newProdPrice, setNewProdPrice] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [newProdStock, setNewProdStock] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminProducts.useEffect": ()=>{
            ...
            const unsubCat = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$adminDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subscribeToCollection"])('categories', {
                "AdminProducts.useEffect.unsubCat": (data)=>{
                    setCategories(data);
                }
            }["AdminProducts.useEffect.unsubCat"]);
            const unsubProd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$adminDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subscribeToCollection"])('products', {
                "AdminProducts.useEffect.unsubProd": (data)=>{
                    const dbProducts = data;
                    // Combine with mock products
                    const existingIds = new Set(dbProducts.map({
                        "AdminProducts.useEffect.unsubProd": (p)=>String(p.id)
                    }["AdminProducts.useEffect.unsubProd"]));
                    const missingMockProducts = __TURBOPACK__imported__module__$5b$project$5d2f$constants$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOCK_PRODUCTS"].filter({
                        "AdminProducts.useEffect.unsubProd.missingMockProducts": (p)=>!existingIds.has(String(p.id))
                    }["AdminProducts.useEffect.unsubProd.missingMockProducts"]).map({
                        "AdminProducts.useEffect.unsubProd.missingMockProducts": (p)=>({
                                id: String(p.id),
                                name: p.name,
                    ...
                    }["AdminProducts.useEffect.unsubProd.missingMockProducts"]);
                    setProducts([
                        ...dbProducts,
                        ...missingMockProducts
                    ]);
    ...
    const handleCreateProduct = async (e)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$adminDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createDocument"])('products', {
                name: newProdName,
    ...
    const handleDelete = async (id, name)=>{
        if (confirm(`Are you sure you want to delete ${name}? This action cannot be undone.`)) {
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$adminDb$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["deleteDocument"])('products', id);
...
_s(AdminProducts, "81GzBj6REB2THXkYNxv1Vjgjfek=");
_c = AdminProducts;
var _c;
...
//# sourceMappingURL=_33370c1b._.js.map