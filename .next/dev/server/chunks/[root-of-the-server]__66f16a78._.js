...
async function GET(request) {
    ...
    const snapshot = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDocs"])(q);
    let dbProducts = snapshot.docs.map((doc)=>({
            id: doc.id,
            ...doc.data()
        }));
    const existingIds = new Set(dbProducts.map((prod)=>String(prod.id)));
    const missingMockProducts = __TURBOPACK__imported__module__$5b$project$5d2f$constants$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MOCK_PRODUCTS"].filter((prod)=>!existingIds.has(String(prod.id))).map((prod)=>({
            ...prod,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__66f16a78._.js.map