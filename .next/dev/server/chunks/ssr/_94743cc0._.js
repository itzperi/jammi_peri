...
"[project]/_pages_legacy/Shop.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const Shop = ()=>{
    ...
    const [products, setProducts] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])([]); // Initialize with empty array, MOCK_PRODUCTS is no longer used directly
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const updateState = ()=>{
            ...
            const missingMockProducts = __TURBOPACK__imported__module__$5b$project$5d2f$constants$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["MOCK_PRODUCTS"].filter((prod)=>!existingIds.has(String(prod.id)));
            const allProducts = [
                ...currentProducts,
                ...missingMockProducts
            ];
            ...
            const fetchedCategoryNames = currentCategories.map((cat)=>cat.name);
        ...
        const unsubProd = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$adminDb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["subscribeToCollection"])('products', (p)=>{
            currentProducts = p.filter((prod)=>!prod.deleted && prod.status !== 'Draft').map((prod)=>({
                    id: prod.id,
                    name: prod.name,
        ...
        const unsubCat = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$adminDb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["subscribeToCollection"])('categories', (c)=>{
            currentCategories = c;
            updateState();
        });
        return ()=>{
...
//# sourceMappingURL=_94743cc0._.js.map