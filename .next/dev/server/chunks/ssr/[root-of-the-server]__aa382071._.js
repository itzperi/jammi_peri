...
function AdminRoles() {
    ...
    async function loadData() {
        setIsLoading(true);
        try {
            const a = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$adminDb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchCollection"])('admins');
            if (a.length === 0) {
                // Mock data if empty
                setAdmins([
                    {
    ...
    const handleCreateAdmin = async (e)=>{
        ...
        try {
            ...
            const id = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$adminDb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createDocument"])('admins', newAdmin);
            setAdmins([
                ...admins,
                {
                    ...newAdmin,
    ...
    const toggleStatus = async (id, currentStatus)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$adminDb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateDocument"])('admins', id, {
                status: newStatus
            });
    ...
    const deleteAdmin = async (id, adminEmail)=>{
        ...
        if (confirm("Delete this admin user?")) {
            try {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$adminDb$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteDocument"])('admins', id);
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                ...
                                                children: [
                                                    ...
                                                    admin.email === currentUserEmail && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__aa382071._.js.map