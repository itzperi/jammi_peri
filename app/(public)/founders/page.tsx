    ...
    return (
        <div className="bg-background-light text-slate-900 font-body min-h-screen">
            ...
            <section className="pt-32 pb-20 px-6 max-w-7xl mx-auto text-center">
                <span className="text-primary font-bold tracking-widest uppercase text-sm mb-4 block">The Guardians of Tradition</span>
            ...
            <section className="py-16 px-6 max-w-7xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                    ...
                    <div className="order-1 lg:order-2 space-y-8">
                        <div>
                            <h2 className="text-4xl lg:text-5xl font-display font-bold text-secondary mb-2">Dr. Narasimham Jammi</h2>
                            <p className="text-primary font-bold uppercase tracking-widest text-sm">Visionary & Co-Founder</p>
                        </div>
            ...
            <section className="py-16 px-6 max-w-7xl mx-auto mb-20">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                    ...
                    <div className="space-y-8">
                        <div>
                            <h2 className="text-4xl lg:text-5xl font-display font-bold text-secondary mb-2">Dr. Anitha Balachander</h2>
                            <p className="text-primary font-bold uppercase tracking-widest text-sm">Co-Founder & Chief Medical Officer</p>
                        </div>
